    ...
    <div class="intro-x relative mr-3 sm:mr-6">
        ...
        <div class="search-result">
            <div class="search-result__content">
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{ asset("assets/dist/images/preview-9.jpg") }}">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{ asset("assets/dist/images/preview-12.jpg") }}">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{ asset("assets/dist/images/preview-10.jpg") }}">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" src="{{ asset("assets/dist/images/preview-7.jpg") }}">
                    </div>
                    <div class="ml-3">Samsung Galaxy S20 Ultra</div>
                    <div class="ml-auto w-48 truncate text-gray-600 text-xs text-right">Smartphone &amp; Tablet</div>
                </a>
